...
TABELAS = [
    {'id': 1, 'TipoTabela': 'NPS', 
     ...
     'Var_Linha': 'NPS_C', 
     'Tipo_var_linha': 'NUMERICA',
     'BTB': '', 'TTB': '',
     'Valores_Agrup': '',
     'Var_Pond': 'POND', 'Onda_Atual': 'Nov23', 'Onda_Anterior': 'Jul23', 'Onda_um_Ano': 'Dez22/Extra'},

     {'id': 2, 'TipoTabela': 'SATISFACAO', 
     'Colunas': 'ONDA, EMP_G, VAR_G, GC_G, ME_G, ESP_G, PJ_G, PF_G', 
     'Var_Linha': 'C_26', 
     'Tipo_var_linha': 'NUMERICA',
     'BTB': '', 'TTB': '',
     ...
     {'id': 3, 'TipoTabela': 'SIMPLES', 
     'Colunas': 'ONDA, EMP_G, VAR_G, GC_G, ME_G, ESP_G, PJ_G, PF_G', 
     'Var_Linha': 'VREG', 
     'Tipo_var_linha': 'CATEGORICA',
     'BTB': '', 'TTB': '',
     'Valores_Agrup': '',
     'Var_Pond': 'POND', 'Onda_Atual': 'Nov23', 'Onda_Anterior': 'Jul23', 'Onda_um_Ano': 'Dez22/Extra'},

     {'id': 4, 'TipoTabela': 'IPA_5', 
     'Colunas': 'ONDA, EMP_G, VAR_G, GC_G, ME_G, ESP_G, PJ_G, PF_G', 
     'Var_Linha': 'VCH_C', 
     'Tipo_var_linha': 'IPA_5',
     'BTB': '', 'TTB': '',
     'Valores_Agrup': 'Com certeza continuaria trabalhando, Provavelmente continuaria trabalhando, Não sei se vou continuar ou não, Provavelmente deixaria de trabalhar, Com certeza deixaria de trabalhar',
     'Var_Pond': 'POND', 'Onda_Atual': 'Nov23', 'Onda_Anterior': 'Jul23', 'Onda_um_Ano': 'Dez22/Extra'},

     {'id': 5, 'TipoTabela': 'MULTIPLA', 
     'Colunas': 'ONDA, EMP_G, VAR_G, GC_G, ME_G, ESP_G, PJ_G, PF_G', 
     'Var_Linha': 'MCHC', 
     'Tipo_var_linha': 'MULTIPLA',
     'BTB': '', 'TTB': '',
     'Valores_Agrup': 'MCHC_1, MCHC_2, MCHC_3',
     'Var_Pond': 'POND', 'Onda_Atual': 'Nov23', 'Onda_Anterior': 'Jul23', 'Onda_um_Ano': 'Dez22/Extra'},

     {'id': 6, 'TipoTabela': 'IPA_10', 
     'Colunas': 'ONDA, EMP_G, VAR_G, GC_G, ME_G, ESP_G, PJ_G, PF_G', 
     'Var_Linha': 'C_26', 
     'Tipo_var_linha': 'NUMERICA',
     'BTB': '1, 2, 3', 'TTB': '8, 9, 10',
     'Valores_Agrup': '',
     'Var_Pond': 'POND', 'Onda_Atual': 'Nov23', 'Onda_Anterior': 'Jul23', 'Onda_um_Ano': 'Dez22/Extra'}
]
...
# data = pd.read_excel('BD para GPT.xlsx')

# todas_tabelas_gerais, todos_resultados_teste = processamento(data, bd_processamento)
